...
export default function GraphPreview({ pages = [], links = [], username, wikiSlug, activePageId }: GraphPreviewProps) {
  ...
  return (
    <Card className="shadow-sm">
      <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 dark:border-zinc-800 p-4 pb-3">
      ...
      <CardContent className="p-4 space-y-4">
        {pages.length === 0 ? (
          ...
          <>
            ...
            <Button variant="outline" className="w-full text-xs font-bold text-[#6b38d4] dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 border-purple-100 dark:border-zinc-800 bg-purple-50/50 dark:bg-purple-950/20 hover:bg-purple-50 dark:hover:bg-purple-950/40" asChild>
              <Link href={`/u/${username}/${wikiSlug}/graph`}>
